    ...
    if (response.statusCode == 200) {
      ...
      if (recipes.isNotEmpty) {
        ...
        if (extendedIngredientsResponse.statusCode == 200) {
          final extendedRecipe = json.decode(extendedIngredientsResponse.body)
              as Map<String, dynamic>;
          final extendedIngredients =
              extendedRecipe['extendedIngredients'] as List<dynamic>;
          ...
          throw Exception(
              'Failed to load extended ingredients and instructions for the recipe');
        }
      }
    } else {
