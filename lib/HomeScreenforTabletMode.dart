...
class _SceneState extends State<Scene> {
  Map<String, dynamic> _recipe = {}; // Initialize with an empty Map

  @override
  void initState() {
    super.initState();
    _fetchRecipe().then((recipe) {
      setState(() {
        _recipe = recipe;
        print(_recipe); // Move the print statement here
      });
    });
  }
      ...
      body: FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<Map<String, dynamic>> snapshot){
            if(snapshot.connectionState == ConnectionState.waiting){
              ...
              Map<String, dynamic> recipe = snapshot.data!;
                                                ...
                                                child: RichText(
                                                  text: TextSpan(
                                                    ...
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                        text: _recipe['preparationMinutes'].toString(),
                                                        style: const TextStyle(
                                                          fontSize: 20,
                                                          fontWeight: FontWeight.w500,
                                                          color: Color(0xff000000),
