        ...
        child: Stack(
          children: [
            Positioned(
              ...
              top: 1091*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(20*fem, 24.88*fem, 19*fem, 26.75*fem),
                width: 86*fem,
                height: 89*fem,
                decoration: BoxDecoration (
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(13*fem, 0*fem, 14*fem, 39*fem),
                            padding: EdgeInsets.fromLTRB(27*fem, 23*fem, 17*fem, 0*fem),
                            width: double.infinity,
                            height: 84*fem,
                            decoration: BoxDecoration (
                              color: Color(0xffffffff),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(10*fem, 17*fem, 10*fem, 19*fem),
                                  width: 107*fem,
                                  height: double.infinity,
                                  decoration: BoxDecoration (
                                    image: DecorationImage (
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3*fem, 63*fem),
                                  width: 287*fem,
                                  height: 93*fem,
                                  child: Stack(
                                    children: [
                                ...
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3*fem, 43*fem),
                                  width: 276*fem,
                                  height: 95*fem,
                                  child: Stack(
                                    children: [
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(1*fem, 0*fem, 74*fem, 0*fem),
                                  width: double.infinity,
                                  height: 93*fem,
                                  decoration: BoxDecoration (
                                    image: DecorationImage (
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            // breakfastWjV (4:9)
                            margin: EdgeInsets.fromLTRB(9*fem, 0*fem, 0*fem, 3*fem),
                            child: Text(
                              'Breakfast',
                              style: SafeGoogleFont (
                                'Inter',
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(16*fem, 23*fem, 16*fem, 10*fem),
                      width: 206*fem,
                      height: double.infinity,
                      decoration: BoxDecoration (
                        color: Color(0xffdbdfd1),
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(26*fem, 18*fem, 48*fem, 15*fem),
                      width: 206*fem,
                      height: double.infinity,
                      decoration: BoxDecoration (
                        color: Color(0xffdbdfd1),
